...
@section('content')
   ...
   <div class="row" style="margin-bottom: 20px;">
       ...
       <div class="col-sm-4 text-right">
           <a href="/manager/whitelist/new" class="btn btn-sm btn-primary">
    ...
    <ul class="list-group">
        @foreach($list as $l)
            ...
            <li class=" list-group-item d-flex justify-content-between align-items-center">
               {{$l->domain}}
                <div class="row">
                    <a style="margin-right: 10px;" href="/manager/whitelist/edit/{{$l->id}}" class="btn btn-sm btn-primary">
                        <span class="far fa-pencil-alt"></span>
                    </a>
                    <form action="{{ url('/manager/whitelist/delete/'.$l->id) }}" method="POST">
                        {!! csrf_field() !!}
                        {!! method_field('DELETE') !!}
